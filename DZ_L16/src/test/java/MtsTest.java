...
public class MtsTest {
    ...
    @DisplayName("Проверка надписей в полях для варианта 'Услуги связи'")
    ...
    @ParameterizedTest
    @Feature("Блок 'Онлайн пополнение без комиссии'")
    @DisplayName("Проверка надписей в полях для варианта 'Домашний интернет'")
    @Severity(SeverityLevel.MINOR)
    ...
    @ParameterizedTest
    @Feature("Блок 'Онлайн пополнение без комиссии'")
    @DisplayName("Проверка надписей в полях для варианта 'Рассрочка'")
    @Severity(SeverityLevel.MINOR)
    ...
    @ParameterizedTest
    @Feature("Блок 'Онлайн пополнение без комиссии'")
    @DisplayName("Проверка надписей в полях для варианта 'Задолженность'")
    @Severity(SeverityLevel.MINOR)
    ...
    @Test
    @Feature("Блок 'Онлайн пополнение без комиссии'")
    @DisplayName("Проверка надписей в полях анкеты пополнения услуг связи")
    @Severity(SeverityLevel.MINOR)
